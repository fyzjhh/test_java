...
// $ANTLR 2.7.7 (2006-11-01): "t.g" -> "T.java"$
...
public class TLexer extends antlr.CharScanner implements TTokenTypes, TokenStream
 {
public TLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public TLexer(Reader in) {
	this(new CharBuffer(in));
}
public TLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public TLexer(LexerSharedInputState state) {
	super(state);
