...
public class MyMD5 {
	 ...
	 */
	public String getMD5(byte[] source) throws Exception {
		md5Init();
		md5Update(source, source.length);
		md5Final();
		digestHexStr = "";
		for (int i = 0; i < 16; i++) {
	...
	public static void main(String args[]) throws Exception {
		...
		String emptyStr = "";
		String normalStr = "abc!@#";
		String zhStr = "1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890";

		String my_zhStr = m.getMD5(zhStr.getBytes("utf8"));
		String my_normalStr = m.getMD5(normalStr.getBytes("utf8"));
		String my_emptyStr = m.getMD5(emptyStr.getBytes("utf8"));

		String java_normalStr = Md5.getMD5(normalStr.getBytes("utf8"));
		String java_emptyStr = Md5.getMD5(emptyStr.getBytes("utf8"));
		String java_zhStr = Md5.getMD5(zhStr.getBytes("utf8"));

		System.out.println(java_emptyStr.equalsIgnoreCase(my_emptyStr));
		System.out.println(java_normalStr.equalsIgnoreCase(my_normalStr));
		System.out.println(java_zhStr.equalsIgnoreCase(my_zhStr));
	}
